'use strict'
// Lingma（通义灵码）适配器：尝试读取 ~/.lingma 下的会话文件
// 注意：Lingma 使用私有二进制格式（.zap + bolt），此适配器提供基础支持
...
function sources(sourceDir) {
  return findSessionFiles(sourceDir || LINGMA_DIR)
}
...
module.exports = { scan, sources, parseFile, id: 'lingma', label: 'Lingma', sourceDir: LINGMA_DIR, sourceFormat: 'jsonl/lingma-transcript' }
